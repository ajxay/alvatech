          ...
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 lg:h2 xl:h1 m-0">
                Custom web & mobile apps built to scale your business
              </h2>
              <p className="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">
                From powerful web platforms to intuitive mobile apps, we design
                and develop digital products that deliver seamless user
                experiences and drive real growth.
              </p>
            </div>
            <div
