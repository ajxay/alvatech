      ...
      <div className="container max-w-lg">
        <div className="page-wrap panel vstack gap-4 lg:gap-6 xl:gap-8">
          <header className="page-header panel vstack justify-center gap-2 lg:gap-4 text-center">
            <div className="panel">
              <h1 className="h3 lg:h1 m-0">Terms &amp; Conditions</h1>
              <p className="fs-7 opacity-60 mt-2 mb-0">
                Effective Date: 01-06-2026 | Last Updated: 30-07-2026
              </p>
            </div>
          </header>
          <div className="page-content panel fs-6 md:fs-5">
            <p>
              Welcome to Alva Tech (&quot;Alva Tech&quot;, &quot;we&quot;,
              &quot;our&quot;, or &quot;us&quot;).
            </p>
            <p>
            ...
            <ul className="list list-bullets">
              ...
              <li>Shopify Development &amp; Migration</li>
              <li>Salesforce Consulting &amp; Implementation</li>
              <li>Zoho CRM Solutions</li>
            ...
            <p>
              Alva Tech provides professional consulting, software development,
              implementation, integration, design, marketing, and digital
            ...
            <ul className="list list-bullets">
              ...
              <li>Supply project materials on time</li>
            ...
            <p>Clients retain ownership of all materials they provide.</p>
            ...
            <h3 className="h4 md:h3 mt-3 lg:mt-6 mb-2">
              14. Intellectual Property for Deliverables
            </h3>
          ...
          <div className="page-footer panel">
            <p className="fs-7 opacity-60 m-0">Last updated: 30 July, 2026</p>
          </div>
        </div>
      </div>
    </div>
