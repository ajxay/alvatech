        ...
        <div className="page-wrap panel vstack gap-4 lg:gap-6 xl:gap-8">
          ...
          <div className="page-content panel fs-6 md:fs-5">
            ...
            <ul className="list list-bullets">
              ...
              <li>ERP Development &amp; Integration</li>
            ...
            <p>We automatically collect technical information using:</p>
            <ul className="list list-bullets">
              <li>Cookies</li>
              <li>Pixels</li>
            ...
            <ul className="list list-bullets">
              ...
              <li>Delivering consultations</li>
              <li>Managing customer relationships</li>
              <li>Sending project proposals</li>
            ...
            <p>Used for personalized advertising and campaign measurement.</p>
            <p>Examples include:</p>
            <ul className="list list-bullets">
            ...
            <p>These platforms may collect information such as:</p>
            <ul className="list list-bullets">
